...
struct OnboardingFlow: View {
    ...
    var body: some View {
        ZStack {
            Color(hex: "#FBF9F1").ignoresSafeArea()
            ...
            case .splash:
                SplashPhase(onStart: {
                    ...
                    withAnimation(.easeInOut(duration: 0.4)) { phase = .ageGate }
                })
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            .overlay(alignment: .bottom) {
                // Gradient underline
                LinearGradient(colors: [Color(hex: "#534AB7"), Color(hex: "#D4960A"), Color(hex: "#E04040"), Color(hex: "#6EAE5E")], startPoint: .leading, endPoint: .trailing)
                    .frame(height: 4)
                    .cornerRadius(2)
                    .opacity(0.5)
                    .offset(y: 6)
    ...
    var body: some View {
        OnboardingContainer {
            if ageStep == 0 {
                            ...
                            Button {
                                ...
                                .background(
                                    RoundedRectangle(cornerRadius: 16)
                                        ...
                                        .overlay(
                                            RoundedRectangle(cornerRadius: 16)
                                                .stroke(selected ? Color(hex: "#D4960A") : Color(hex: "#EBE8DF"), lineWidth: selected ? 2 : 1)
                                        )
                                        .shadow(color: selected ? Color(hex: "#D4960A").opacity(0.15) : Color.black.opacity(0.04), radius: selected ? 8 : 3, y: 2)
                                )
                            }
                            .buttonStyle(.plain)
                        }
                ...
                // Sign-in step
                VStack(spacing: 20) {
                    Text(appState.userAge == "12-15" ? "Create your profile" : "Save your journey")
                        .font(.system(size: 28, weight: .bold))
                        .foregroundColor(Color(hex: "#2D2B26"))

                    Text(appState.userAge == "12-15" ? "No email needed! Your profile is saved on this device." : "Sign in to sync your progress across devices.")
                        .font(.system(size: 14))
                        .foregroundColor(Color(hex: "#666666"))
                                ...
                                Button {
                                    ...
                                    .background(
                                        RoundedRectangle(cornerRadius: 18)
                                            ...
                                            .overlay(
                                                RoundedRectangle(cornerRadius: 18)
                                                    .stroke(activeChar == charId ? c.color : Color(hex: "#EBE8DF"), lineWidth: activeChar == charId ? 2 : 1)
                                            )
                            ...
                            Button {
                                ...
                                .background(
                                    RoundedRectangle(cornerRadius: 16)
                                        ...
                                        .shadow(color: selected ? Color(hex: "#D4960A").opacity(0.15) : .black.opacity(0.04), radius: selected ? 8 : 3, y: 2)
                                )
