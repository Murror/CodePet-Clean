...
struct ChallengeCard: View {
    ...
    var body: some View {
        HStack(spacing: 14) {
            ...
            ZStack {
                Circle()
                    .fill(state == .locked ? Color(hex: "#E8E6E0") : (teacher?.color ?? .gray).opacity(0.15))
                ...
                VStack(spacing: 4) {
                    Button(action: onStart) {
                        Text("Start")
                            ...
                            .padding(.vertical, 6)
                            .background(teacher?.color ?? Color(hex: "#D4960A"))
                            .cornerRadius(8)
                    }
                    .buttonStyle(.plain)
            ...
            HStack(spacing: 4) {
                ForEach(0..<6, id: \.self) { i in
                    RoundedRectangle(cornerRadius: 2)
                        .fill(i < stage ? Color(hex: "#6BCB77") : (i == stage ? teacherColor : Color(hex: "#E0DDD6")))
                        .frame(height: 4)
                }
            }
            ...
            ForEach(ChallengeTool.all) { tool in
                ...
                .background(
                    RoundedRectangle(cornerRadius: 12)
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 12)
                                .stroke(isSelected ? tool.color.opacity(0.4) : Color(hex: "#EBE8DF"), lineWidth: isSelected ? 2 : 1)
                        )
                )
                .onTapGesture {
                ...
                Button(action: { withAnimation { showSampleAnswer.toggle() } }) {
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 12)
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 12)
                                    .stroke(showSampleAnswer ? teacherColor.opacity(0.3) : Color(hex: "#EBE8DF"), lineWidth: 1.5)
                            )
                    )
                }
                .buttonStyle(.plain)
...
struct ConfettiView: View {
    ...
    var body: some View {
        ...
        .ignoresSafeArea()
        .onAppear {
            let colors: [Color] = [.red, .orange, .yellow, .green, .blue, .purple, .pink, Color(hex: "#6BCB77"), Color(hex: "#D89840")]
