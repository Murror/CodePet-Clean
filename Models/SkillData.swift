...
struct GameData {
    static let skillTiers: [SkillTier] = [
        SkillTier(
            ...
            skills: [
                Skill(id: "prompt-clarity", name: "Prompt Clarity", icon: "✏️", desc: "Learn how to tell AI exactly what you want."),
                Skill(id: "error-reading", name: "Error Reading", icon: "🔍", desc: "Understand what error messages are really telling you."),
                Skill(id: "tool-basics", name: "Tool Basics", icon: "🛠️", desc: "Know which AI tool to use for what."),
                Skill(id: "code-judgment", name: "Code Judgment", icon: "⚖️", desc: "Learn when to trust AI's code and when to say 'try again'."),
            ]
        ),
        SkillTier(
            id: 2,
            ...
            skills: [
                Skill(id: "context-setting", name: "Context Setting", icon: "🎯", desc: "Tell AI about your project before asking it to code."),
                Skill(id: "rules-files", name: "AI Rules Files", icon: "📏", desc: "Create a file that tells AI your rules automatically."),
                Skill(id: "documentation", name: "Documentation", icon: "📄", desc: "Write docs that help both you and AI."),
                Skill(id: "file-structure", name: "Project Structure", icon: "📁", desc: "Organize files so AI can find the right ones."),
            ]
        ),
        SkillTier(
            id: 3,
            ...
            skills: [
                Skill(id: "tool-switching", name: "Tool Switching", icon: "🔄", desc: "Know when to switch AI tools."),
                Skill(id: "scope-mgmt", name: "Scope Mgmt", icon: "📦", desc: "Break big ideas into small pieces AI can build."),
                Skill(id: "design-system", name: "Design System", icon: "🎨", desc: "Keep your app looking consistent."),
                Skill(id: "iteration", name: "Prompt Iteration", icon: "🔁", desc: "Refine prompts step by step."),
            ]
        ),
        SkillTier(
            id: 4,
            name: "Expert",
            kingdom: "The Storm Summit",
            kingdomColor: Color(hex: "#90D870"),
            color: Color(hex: "#C07AB8"),
            skills: [
                Skill(id: "personas", name: "User Personas", icon: "🧩", desc: "Define who you're building for."),
                Skill(id: "context-windows", name: "Context Windows", icon: "🧠", desc: "Understand AI's memory limits."),
                Skill(id: "architecture", name: "AI Architecture", icon: "🏗️", desc: "Design projects AI can help maintain."),
                Skill(id: "second-brain", name: "Second Brain", icon: "💡", desc: "Build a personal knowledge system."),
            ]
        ),
    ]
